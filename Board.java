...
public class Board extends JPanel
{
  ...
  // Grid colours
  private static final Color GRID_COLOR_A = new Color(180,180,180);
  private static final Color GRID_COLOR_B = new Color(115,115,115);
  ...
  private void paintGrid(Graphics g)
  {
    for (int i = 0; i < this.grid.length; i++)
    {
      ...
      {    
        ...
        /* I added this to make the lines
        ((Graphics2D) g).setStroke( new BasicStroke(4f) );
        g.setColor(Color.BLACK);
        g.drawLine(curX+deltaX, curY, curX+deltaX, curY+deltaY);
        g.drawLine(curX, curY+deltaY, curX+deltaX, curY+deltaY);
        */
      }
    }
